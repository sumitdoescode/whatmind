...
const Hero = () => {
    return (
        <Section id="hero" paddingLevel="low">
            <Container>
                <div className="hero flex items-center justify-center">
                    <div className="pt-20 pb-9 lg:pt-32 lg:pb-16 text-center max-w-3xl">
                        ...
                        <a
                            href="#contact"
                            className="border-0 outline-none text-lg sm:text-xl lg:text-2xl text-dark bg-primary font-medium inline-block no-underline py-1 px-2 md:py-2 md:px-4 rounded-md mt-6"
                        >
                            Ask here
                        </a>
